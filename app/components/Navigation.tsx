...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white shadow-sm" style={{ fontFamily: '"Cy Grotesk Grand", sans-serif' }}>
      ...
      >
        <div className="flex flex-col p-6">
          <button
            className="self-end mb-6 text-2xl text-black"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            ×
          </button>
          <div className="flex flex-col space-y-4">
            ...
            <a
              href="#contact"
              className="font-bold text-black hover:text-gray-600 py-2"
              onClick={(e) => {
